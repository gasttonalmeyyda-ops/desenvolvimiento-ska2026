(() => {
  ...
  // src/Assasino.ts
  var Esparto = class extends Personagem {
    veneno = 0;
  ...
  var Jogo = class {
    ...
    atualizarinterface(jogadorUm, jogadorDois) {
      document.getElementById("jogadorUmVida").textContent = "HP: " + jogadorUm.getVida();
      document.getElementById("jogadorDoisVida").textContent = "HP: " + jogadorDois.getVida();
    }
    pegaComponenteHtml() {
    }
    esperaTempo() {
  ...
  function construirJogo() {
    let mago = new Mago("Mago", 400, 100, 5);
    let guerreiro = new Assasino("Esparto", 500, 150, 5, 5);
    let jogo = new Jogo();
